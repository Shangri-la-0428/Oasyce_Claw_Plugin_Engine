...
For real public testnet onboarding, follow the chain-side guide on [chain.oasyce](https://chain.oasyce.com). `oas sandbox *` is the local sandbox simulation; `oas testnet *` remains only as a compatibility alias.
