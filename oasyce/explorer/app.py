...
<table>
  ...
  <tbody>{tx_rows}</tbody>
        ...
        if tx_rows
        else '<p style="color:#888;">No transactions in this block.</p>'
    )
...
<table>
  ...
  <tbody>{rows}</tbody>
        ...
        if rows
        else '<p style="color:#888;">No assets registered.</p>'
    )
...
<table>
  ...
  <tbody>{rows}</tbody>
        ...
        if rows
        else '<p style="color:#888;">No validators registered.</p>'
    )
...
<table>
  ...
  <tbody>{rows}</tbody>
        ...
        if rows
        else '<p style="color:#888;">No peers discovered yet.</p>'
    )
