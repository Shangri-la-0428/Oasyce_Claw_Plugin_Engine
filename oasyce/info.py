...
BETA_ONBOARDING: Dict[str, str] = {
    "en": (
        ...
        "  - Real public testnet identity onboarding still follows the chain docs; `oas testnet *` commands are local simulation commands for sandbox testing.\n"
    ...
    "zh": (
        ...
        "  - 真实公开测试网身份接入目前仍以链侧文档为准；`oas testnet *` 只是本地沙盒模拟命令。\n"
