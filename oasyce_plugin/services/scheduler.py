...
class AgentScheduler:
    ...
    def run_once(self) -> RunResult:
        ...
        logger.info(
            ...
            result.scan_count, result.register_count, result.trade_count,
            len(errors), duration_ms,
        )
        return result

    def _execute_trades(
        self, trade_tags: List[str], max_spend: float, errors: List[str]
    ) -> int:
        ...
        spent = 0.0
        try:
            from oasyce_plugin.services.discovery.engine import DiscoveryEngine
