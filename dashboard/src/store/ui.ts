...
const dict: Record<string, Record<string, string>> = {
  zh: {
    ...
    'pay': '需要支付',
    'confirm-buy': '确认购买', 'buying': '处理中...', 'back': '返回',
    // Access level system
    ...
    'invoke-result': '返回结果',
    'net-cat-config': '配置', 'net-cat-chain': '网络与共识', 'net-cat-tools': '工具',
  ...
  en: {
    ...
    'pay': 'You pay',
    'confirm-buy': 'Confirm purchase', 'buying': 'Processing...', 'back': 'Back',
    // Access level system
    ...
    'net-cat-config': 'CONFIGURATION', 'net-cat-chain': 'NETWORK & CONSENSUS', 'net-cat-tools': 'TOOLS',
