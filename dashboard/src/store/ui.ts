...
const dict: Record<string, Record<string, string>> = {
  zh: {
    ...
    'buy-success': '购买成功',
    'portfolio': '持仓', 'no-holdings': '暂无持仓', 'avg-price': '均价', 'shares': '份额',
    ...
    // Transaction history
    'tx-history': '交易记录', 'tx-no-history': '暂无交易记录',
    // Jury voting
    ...
    // Asset lifecycle
    'asset-shutdown': '优雅退出',
    'asset-shutdown-confirm': '确认发起退出？冷却期7天，期间不可撤回。',
    'asset-shutdown-success': '退出已发起，7天后可终止',
    'asset-terminate': '终止资产', 'asset-terminate-success': '资产已终止',
    'asset-claim': '认领清算', 'asset-claim-success': '清算已认领',
    'asset-status-active': '活跃', 'asset-status-shutdown': '退出中', 'asset-status-terminated': '已终止',
    // Version history
    'version-history': '版本历史', 'no-versions': '暂无版本记录',
    'version-number': '版本', 'version-time': '时间',
    // Governance
    'governance': '治理', 'governance-desc': '提案与投票（本地模拟）',
    'gov-proposals': '提案列表', 'gov-no-proposals': '暂无提案',
    ...
    'wallet-import-hint': '粘贴密钥 JSON 内容',
    // Fingerprint list
    'fingerprint-list': '指纹记录', 'fingerprint-no-records': '暂无指纹记录',
    'fingerprint-asset': '关联资产',
    // Reputation
    'node-reputation': '信誉分',
    ...
    'bounty-list': '可用任务', 'bounty-no-tasks': '暂无可用任务',
    ...
    // Contribution proof
    'contribution': '贡献证明', 'contribution-desc': '生成和验证数据贡献证明',
  ...
  en: {
    ...
    'spot-price': 'Spot price', 'tags': 'Tags', 'type': 'Type', 'asset-type-data': 'Data',
    'buy-success': 'Purchase successful',
    'portfolio': 'Portfolio', 'no-holdings': 'No holdings yet', 'avg-price': 'Avg price', 'shares': 'Shares',
    ...
    'sell-slippage': 'Max slippage', 'sell-success': 'Sold successfully',
    // Transaction history
    'tx-history': 'Transaction History', 'tx-no-history': 'No transactions yet',
    // Jury voting
    ...
    // Asset lifecycle
    'asset-shutdown': 'Graceful Shutdown',
    'asset-shutdown-confirm': 'Start shutdown? 7-day cooldown period, cannot be undone.',
    'asset-shutdown-success': 'Shutdown initiated, terminable after 7 days',
    ...
    'asset-status-active': 'Active', 'asset-status-shutdown': 'Shutting down', 'asset-status-terminated': 'Terminated',
    // Version history
    'version-history': 'Version History', 'no-versions': 'No version history',
    'version-number': 'Version', 'version-time': 'Time',
    // Governance
    'governance': 'Governance', 'governance-desc': 'Proposals & voting (local simulation)',
    'gov-proposals': 'Proposals', 'gov-no-proposals': 'No proposals yet',
    ...
    'wallet-import-hint': 'Paste key JSON content',
    // Fingerprint list
    'fingerprint-list': 'Fingerprint Records', 'fingerprint-no-records': 'No fingerprint records',
    ...
    'bounty-list': 'Open Tasks', 'bounty-no-tasks': 'No open tasks',
    ...
    // Contribution proof
    'contribution': 'Contribution Proof', 'contribution-desc': 'Generate and verify data contribution proofs',
    ...
    'contribution-prove-success': 'Contribution proof generated',
    ...
    // Leakage budget
    'leakage': 'Leakage Budget', 'leakage-desc': 'View and manage data leakage budgets',
