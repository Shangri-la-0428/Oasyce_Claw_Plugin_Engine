...
echo "    oasyce testnet join --genesis ${OUTPUT_DIR}/genesis.json --data-dir ${OUTPUT_DIR}/node-0"
echo ""
echo "  To start all nodes:"
echo "    for i in \$(seq 0 $((VALIDATORS - 1))); do"
echo "      oasyce testnet join --genesis ${OUTPUT_DIR}/genesis.json --data-dir ${OUTPUT_DIR}/node-\$i &"
echo "    done"
